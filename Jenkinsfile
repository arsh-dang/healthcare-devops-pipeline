                                ...
                                sh '''
                                    ...
                                    if command -v npm >/dev/null 2>&1; then
                                        ...
                                        if [ -f "server/package.json" ]; then
                                            cd server
                                            npm install --legacy-peer-deps || echo "Backend dependencies installed"
                                            cd ..
                                        else
                                            npm install --legacy-peer-deps || echo "Backend dependencies installed"
                                        fi
                                ...
                                sh '''
                                    ...
                                    if command -v npm >/dev/null 2>&1; then
                                        ...
                                        if [ -f "pnpm-lock.yaml" ]; then
                                            ...
                                            npm ci --cache .npm --legacy-peer-deps >/dev/null 2>&1 || echo "Dependencies already installed"
                                        else
                                            pnpm install --no-frozen-lockfile >/dev/null 2>&1 || echo "Dependencies already installed"
                                        fi
...
EOF
                                    ...
                                    if command -v npm >/dev/null 2>&1; then
                                        ...
                                        npm install --legacy-peer-deps >/dev/null 2>&1 || echo "Dependencies already installed"
